...
var Package = require("metadata-lib").Package;
...
module.exports.fromPackageXml = function(xmlString) {
	var packageXml = Package.parse(xmlString);
	return new Manifest({
		manifestJSON: packageXml.getFileProperties().map(function(fp){
			return new MetadataComponent(fp)
		}),
		apiVersion: packageXml.version
	});
};
...
Manifest.prototype.toPackageXml = function(destructive) {
	...
	return Package.fromManifest({
		fileProperties: self.manifestJSON,
