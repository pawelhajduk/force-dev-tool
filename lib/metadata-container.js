	...
	return miss.through.obj(function(metadataContainer, end, cb) {
		if (metadataContainer) {
			if (opts.excludeIgnored) {
				...
				metadataContainer.destructiveManifest.manifestJSON = Manifest.filterExcludedMetadata(metadataContainer.destructiveManifest.manifestJSON, opts.ignorePatterns);
			}
		}
		cb(null, metadataContainer);
	});
